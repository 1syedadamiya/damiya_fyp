...
from .views import uetuni, ueuni, puuni, kcuni, ituuni, lcwuuni, gcuni, gcdepts, itudepts, kcdepts, lcwudepts, pundepts, puodepts, uetdepts, uedepts
from . import views
urlpatterns = [
    ...
    path('puuni/<str:deptname>/', pundepts, name="pundepts"),
